  ...
  return (
   <main className='min-h-dvh flex items-center justify-center'>
    <div className=' space-y-10'>
       ...
       <div className=' boerder flex flex-col  gap-10'>
          <form
      action={async () => {
        "use server"
        await signIn("google")
    ...
    >
      <button className='border w-full flex items-center justify-center gap-3 text-lg rounded-full py-3 '>
       ...
       <p className='text-sm max-md:text-center text-gray-500'>By signing in,agree with our <span className='hover:text-blue-600 hover:underline'>Terms of Use</span>, and <span className='hover:text-blue-600 hover:underline'>privacy policy </span> </p>
    </div>
   </main>
  )
}
