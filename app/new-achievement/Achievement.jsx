...
const Achievement = ({ session }) => {
    ...
    return (
        <main className="min-h-dvh md:p-5 p-2">
            <h1 className="text-center text-gray-800 md:text-3xl text-xl font-bold relative z-20">
            ...
            >
                <Form className="max-w-3xl mx-auto my-5 space-y-5">
                    ...
                    >
                        {
                            processing ? <RiLoader4Fill className="animate-spin text-2xl" /> : " Share Achievement"
                        }
            ...
            <div className={`${showModal ? "flex" : "hidden"} h-dvh bg-black/50 w-full absolute inset-0 flex items-center justify-center`}>
                <div className="w-80 h-52 bg-white shadow-md relative p-5 flex justify-center items-center flex-col">
                    <FaRegCheckCircle className="text-5xl text-green-600 mx-auto" />
                    <p className="text-center text-lg">
                        Your achievement has been recorded
                    </p>
                    <button className="right-2 absolute top-2 " onClick={()=> setShowModal(false)}>
                        <IoMdClose className="text-2xl text-red-700"/>
                    </button>
                </div>
            </div>
