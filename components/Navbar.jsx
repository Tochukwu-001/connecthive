      ...
      {session ? (
        <>
          ...
          <img
            ...
            className="w-10 h-10 ml-7 rounded-full cursor-pointer"
            onClick={handleClick}
          />
          </button>
          <Menu
          ...
          >
            ...
            <MenuItem onClick={handleClose}>
              <Link href="/new-achievement" className="text-gray-800">
                Add New Achievement
              </Link>
            </MenuItem>
            <MenuItem onClick={handleLogout} className="text-gray-800">
              Logout
            </MenuItem>
          </Menu>
        </>
